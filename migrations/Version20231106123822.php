 ...
 */
final class Version20231106123822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE personne (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, date_creation VARCHAR(255) DEFAULT \'CURRENT_TIMESTAMP\' NOT NULL, description LONGTEXT DEFAULT NULL, is_educateur TINYINT(1) DEFAULT NULL, description_educateur LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_FCEC9EF86CC499D (pseudo), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
