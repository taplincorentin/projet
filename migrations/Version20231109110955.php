 ...
 */
final class Version20231109110955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chien (id INT AUTO_INCREMENT NOT NULL, personne_id INT NOT NULL, nom VARCHAR(20) NOT NULL, image_name VARCHAR(255) DEFAULT NULL, date_naissance DATE NOT NULL, description LONGTEXT DEFAULT NULL, date_actualisation DATETIME NOT NULL, INDEX IDX_13A4067EA21BD112 (personne_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE personne (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, pseudo VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, description LONGTEXT DEFAULT NULL, is_educateur TINYINT(1) DEFAULT NULL, description_educateur LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_FCEC9EFE7927C74 (email), UNIQUE INDEX UNIQ_FCEC9EF86CC499D (pseudo), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
